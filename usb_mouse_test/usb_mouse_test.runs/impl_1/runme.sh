...
HD_PWD='C:/Users/vorte/ECE385/fpga_final_project/usb_mouse_test/usb_mouse_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log usb_mouse_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source usb_mouse_system_wrapper.tcl -notrace
