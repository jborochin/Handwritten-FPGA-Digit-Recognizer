...
HD_PWD='C:/Users/vorte/ECE385/fpga_final_project/usb_mouse_test/usb_mouse_test.runs/usb_mouse_system_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log usb_mouse_system_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source usb_mouse_system_clk_wiz_0_0.tcl
