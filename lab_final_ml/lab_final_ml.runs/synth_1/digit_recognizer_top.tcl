...
namespace eval ::optrace {
  variable script "C:/Users/vorte/ECE385/fpga_final_project/lab_final_ml/lab_final_ml.runs/synth_1/digit_recognizer_top.tcl"
...
synth_design -top digit_recognizer_top -part xc7s50csga324-1
...
write_checkpoint -force -noxdef digit_recognizer_top.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file digit_recognizer_top_utilization_synth.rpt -pb digit_recognizer_top_utilization_synth.pb"
