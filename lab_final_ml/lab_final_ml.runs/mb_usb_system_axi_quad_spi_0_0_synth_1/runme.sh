...
HD_PWD='C:/Users/vorte/ECE385/fpga_final_project/lab_final_ml/lab_final_ml.runs/mb_usb_system_axi_quad_spi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_usb_system_axi_quad_spi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_usb_system_axi_quad_spi_0_0.tcl
